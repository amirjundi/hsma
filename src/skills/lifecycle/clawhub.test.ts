    ...
    expect(refused).toEqual([
      {
        ...
        code: "force_required",
        error:
          'Skill "weather" was installed before HSMA recorded file fingerprints, so local changes cannot be detected. Updating replaces the installed skill directory.',
      },
    ]);
