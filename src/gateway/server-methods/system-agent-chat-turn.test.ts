...
describe("system-agent chat input", () => {
  it.each([
    ...
    },
    {
      ...
      error: "Delegated HSMA sessions cannot submit structured wizard answers.",
    },
    {
      input: {
        sessionId: "s1",
      ...
      error: "A wizard answer cannot reset its HSMA chat session.",
    },
    {
      input: {
        sessionId: "s1",
    ...
    },
    {
      ...
      error: "Delegated HSMA sessions cannot cancel hosted wizards.",
    },
    {
      input: {
        sessionId: "s1",
      ...
      error: "A wizard cancel cannot reset its HSMA chat session.",
    },
