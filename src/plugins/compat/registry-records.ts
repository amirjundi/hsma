...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "hsma package root loadSessionStore",
      "hsma package root saveSessionStore",
    ],
  ...
  },
  {
    ...
    releaseNote:
      "Published HSMA channel packages through 2026.7.1 remain loadable while they migrate to plugin-owned config and setup helpers.",
  },
  {
