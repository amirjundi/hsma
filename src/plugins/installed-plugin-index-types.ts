...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by HSMA from plugin manifests, install records, and config policy. Use `hsma plugins registry --refresh`, `hsma plugins install/update/uninstall`, or `hsma plugins enable/disable` instead.";
