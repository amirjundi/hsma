...
describe("loadMergedBundleMcpConfig", () => {
  it("lets HSMA mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps HSMA transports to downstream CLI types when requested", () => {
    expect(
  ...
  it("keeps disabled HSMA MCP servers out of embedded runtimes", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {
  ...
  it("lets disabled HSMA MCP servers tombstone bundle defaults with the same name", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {
