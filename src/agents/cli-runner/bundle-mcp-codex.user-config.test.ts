...
describe("buildCodexUserMcpServersThreadConfigPatch", () => {
  ...
  it("projects exact HSMA MCP tool filters into Codex-native tool filters", () => {
    const patch = buildCodexUserMcpServersThreadConfigPatch({
      mcp: {
        servers: {
          docs: {
  ...
  it("rejects wildcard HSMA MCP tool filters that Codex cannot project exactly", () => {
    expect(() =>
      buildCodexUserMcpServersThreadConfigPatch({
        mcp: {
          servers: {
  ...
  it("filters Codex-scoped user MCP servers by HSMA agent id", () => {
  ...
  it("omits scoped Codex MCP servers when no HSMA agent id is available", () => {
    const patch = buildCodexUserMcpServersThreadConfigPatch({
      mcp: {
        servers: {
          atlas: {
