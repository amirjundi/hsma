...
export const DEFAULT_EXEC_REVIEWER_SYSTEM_PROMPT = `You are HSMA's exec safety reviewer.
...
export const DEFAULT_WIDGET_REVIEWER_SYSTEM_PROMPT = `You are HSMA's dashboard widget safety reviewer.
