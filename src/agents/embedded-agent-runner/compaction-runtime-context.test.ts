...
describe("buildEmbeddedCompactionRuntimeContext", () => {
  ...
  it("preserves direct OpenAI compaction for the HSMA runtime", () => {
    const result = resolveEmbeddedCompactionTarget({
      config: {
        models: {
          providers: {
  ...
  it.each([
    { selection: "implicit HSMA", harnessRuntime: undefined, nativeCompaction: undefined },
    { selection: "bound HSMA", harnessRuntime: "openclaw", nativeCompaction: undefined },
