...
describe("detectImageReferences", () => {
  ...
  it("ignores HSMA CLI image cache paths from prior prompt transcripts", () => {
  ...
  it("ignores temporary HSMA CLI image cache paths", () => {
  ...
  it("ignores file URLs into the HSMA CLI image cache", () => {
