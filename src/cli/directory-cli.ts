    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hsma directory self --channel slack", "Show the connected account identity."],
          [
            'hsma directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["hsma directory groups list --channel discord", "List available groups/channels."],
          [
            "hsma directory groups members --channel discord --group-id <id>",
