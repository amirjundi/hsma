      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["hsma gateway run", "Run the gateway in the foreground."],
            ["hsma gateway status", "Show service status plus connectivity/capability."],
            ["hsma gateway auth-token --show", "Reveal the shared token interactively."],
            ["hsma gateway discover", "Find local and wide-area gateway beacons."],
            ["hsma gateway stability", "Show recent stability diagnostics."],
            ["hsma gateway call health", "Call a gateway RPC method directly."],
