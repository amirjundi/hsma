    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hsma node run --host 127.0.0.1 --port 18789", "Run the node host in the foreground."],
          ["hsma node status", "Check node host service status."],
          ["hsma node install", "Install the node host service."],
          ["hsma node start", "Start the installed node host service."],
          ["hsma node restart", "Restart the installed node host service."],
