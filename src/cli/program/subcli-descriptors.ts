...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
  ...
  {
    name: "connect",
    description: "Connect this machine to an HSMA Gateway as a node",
  ...
  {
    name: "docs",
    description: "Search the live HSMA docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the HSMA debug proxy and inspect captured traffic",
    hasSubcommands: true,
  ...
  {
    name: "plugins",
    description: "Manage HSMA plugins and extensions",
    hasSubcommands: true,
    parentDefaultHelp: true,
  },
  {
