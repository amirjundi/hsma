...
const EXAMPLES = [
  ["hsma onboard", "Run guided setup for a local Gateway, workspace, auth, and channels."],
  ["hsma setup", "Create the baseline config, workspace, and session folders."],
  ["hsma configure", "Change models, Gateway, channels, plugins, skills, and health checks."],
  ["hsma status", "Check Gateway, channel, model, and recent-session status."],
  ["hsma doctor --fix", "Repair common config, service, plugin, and channel problems."],
  ["hsma channels add", "Add or update a chat channel account with guided prompts."],
  ["hsma channels status", "See connected messaging accounts and login state."],
  ["openclaw --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["hsma gateway run --force", "Start the Gateway and replace anything bound to its port."],
  ["hsma models status", "Show model/provider auth health before running agents."],
  ["hsma plugins list", "Inspect enabled, disabled, and installed plugins."],
  [
    'hsma agent --to +15555550123 --message "Run summary" --deliver',
    "Run one agent turn through the Gateway and optionally deliver the reply.",
  ],
  [
    'hsma message send --channel telegram --target @mychat --message "Hi"',
...
export function configureProgramHelp(
  ...
  program
    ...
    .option(
      "--dev",
      "Dev profile: isolate state under ~/.hsma-dev, default gateway port 19001, and shift derived ports (browser/canvas)",
    )
    .option(
      "--profile <name>",
